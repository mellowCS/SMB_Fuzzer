...
bitflags! {
    struct NegotiateFlags: u32 {
        ...
        const NEG_56 = 0b10000000_00000000_00000000_00000000;
        ...
        const NEG_KEY_EXCH = 0b01000000_00000000_00000000_00000000;
        ...
        const NEG_128 = 0b00100000_00000000_00000000_00000000;
        ...
        const NEG_VERSION = 0b00000010_00000000_00000000_00000000;
        /// ONE ZERO BIT HERE
        ...
        const NEG_TARGET_INFO = 0b00000000_10000000_00000000_00000000;
        /// R (1 bit): If set, requests the usage of the LMOWF. An alternate name for this field is
        /// NTLMSSP_REQUEST_NON_NT_SESSION_KEY.
        const REQ_NON_NT_SESSION_KEY = 0b00000000_01000000_00000000_00000000;
        /// One ZERO BIT HERE
        /// Q (1 bit): If set, requests an identify level token. An alternate name for this field is
        /// NTLMSSP_NEGOTIATE_IDENTIFY.
        const NEG_IDENTIFY = 0b00000000_00010000_00000000_00000000;
        ...
        const NEG_EXTENDED_SESSION_SEC = 0b00000000_00001000_00000000_00000000;
        /// One ZERO BIT HERE
        ...
        const TARGET_TYPE_SERVER = 0b00000000_00000010_00000000_00000000;
        ...
        const TARGET_TYPE_DOMAIN = 0b00000000_00000001_00000000_00000000;
        ...
        const NEG_ALWAYS_SIGN = 0b00000000_00000000_10000000_00000000;
        /// One ZERO BIT HERE
        ...
        const NEG_OEM_WORKSTATION_SUPPLIED = 0b00000000_00000000_00100000_00000000;
        /// K (1 bit): If set, the domain name is provided. An alternate name for this field is NTLMSSP_NEGOTIATE_OEM_DOMAIN_SUPPLIED.
        const NEG_OEM_DOMAIN_SUPPLIED = 0b00000000_00000000_00010000_00000000;
        /// J (1 bit): If set, the connection SHOULD be anonymous.
        const ANONYMOUS = 0b00000000_00000000_00001000_00000000;
        /// One ZERO BIT HERE
        ...
        const NEG_NTLM = 0b00000000_00000000_00000010_00000000;
        /// One ZERO BIT HERE
        ...
        const NEG_LM_KEY = 0b00000000_00000000_00000000_10000000;
        ...
        const NEG_DATAGRAM = 0b00000000_00000000_00000000_01000000;
        ...
        const NEG_SEAL = 0b00000000_00000000_00000000_00100000;
        ...
        const NEG_SIGN = 0b00000000_00000000_00000000_00010000;
        /// ONE ZERO BIT HERE
        ...
        const REQ_TARGET = 0b00000000_00000000_00000000_00000100;
        ...
        const NEG_OEM = 0b00000000_00000000_00000000_00000010;
        ...
        /// A==0 and B==1: The choice of character set encoding MUST be OEM.
        /// A==0 and B==0: The protocol MUST return SEC_E_INVALID_TOKEN.
        const NEG_UNICODE = 0b00000000_00000000_00000000_00000001;
    }
}
