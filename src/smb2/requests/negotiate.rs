...
impl Dialects {
    ...
    pub fn unpack_byte_code(&self) -> Vec<u8> {
        match self {
            ...
            Dialects::SMB21 => b"\x02\x10".to_vec(),
            Dialects::SMB30 => b"\x03\x00".to_vec(),
            Dialects::SMB302 => b"\x03\x02".to_vec(),
            Dialects::SMB311 => b"\x03\x11".to_vec(),
        }
    }
